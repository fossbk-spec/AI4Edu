---
title: Kho Sách Giáo Khoa PDF Điện Tử Lớp 1 - 5 (Bộ Kết Nối Tri Thức)
description: Tổng hợp trọn bộ file PDF Sách giáo khoa từ Lớp 1 đến Lớp 5 cho tất cả các môn học thuộc bộ sách Kết nối tri thức với cuộc sống (NXB Giáo dục Việt Nam)
---
...
```mermaid
graph TD
    Root[Bộ Sách Kết Nối Tri Thức Với Cuộc Sống] --> G1[🧸 Khối Lớp 1]
    Root --> G2[🎒 Khối Lớp 2]
    Root --> G3[📘 Khối Lớp 3]
    Root --> G4[🔬 Khối Lớp 4]
    Root --> G5[🎓 Khối Lớp 5]
    G1 --> P1[Toán 1, Tiếng Việt 1, TN&XH 1, Đạo đức 1, HĐTN 1]
    G2 --> P2[Toán 2, Tiếng Việt 2, TN&XH 2, Đạo đức 2, HĐTN 2]
    G3 --> P3[Toán 3, Tiếng Việt 3, TN&XH 3, Tin học 3, Công nghệ 3]
    G4 --> P4[Toán 4, Tiếng Việt 4, Khoa học 4, Lịch sử - Địa lý 4, Tin học 4]
    G5 --> P5[Toán 5, Tiếng Việt 5, Khoa học 5, Lịch sử - Địa lý 5, Tin học 5]
```
