...
```mermaid
graph TD
    HM[Cẩm Nang AI Tiểu Học Hoàng Mai] --> P1[1. Soạn KHBD 5 Cột CV 2345 & Chatbot Đóng Vai]
    HM --> P2[2. Phân Hóa 4 Tầng Nhiệm Vụ Cho HS Khá Giỏi]
    HM --> P3[3. Đánh Giá & Nhận Xét TT 27 + Bảo Mật Excel]
    HM --> P4[4. Xây Dựng Học Liệu Đa Phương Thức AI]
    HM --> P5[5. Quy Trình Công Cụ Số: AI + Canva/Quizizz/Excel]
    HM --> P6[6. Dự Án STEM/STEAM & Năng Lực Số Cho Học Sinh]
    HM --> P7[7. Prompt Chaining & Trợ Lý AI Khối 1 - 5]
```
